export const ResetPasswordTemplate = (code: number, username?: string, type: "verify" | "reset" = "reset"): string => `
        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden; border: 1px solid #e4e4e7;">
          ...
          <tr>
            <td style="padding: 36px 32px;">
              <p style="font-size:22px; font-weight:600; color:#09090b; margin:0 0 8px;">
              ...
              <p style="font-size:13px; color:#a1a1aa; margin:0; line-height:1.7;">
                ${type === "reset"
                  ? "If you didn't request a password reset, you can safely ignore this email. Your account won't be affected."
